...
<header class="sticky top-0 z-30 bg-white border-b px-5 py-4 flex justify-between items-center">
<h1 class="text-xl font-bold text-amber-900">🥃 Whisky Stock</h1>
<div id="stats" class="text-xs bg-slate-100 px-3 py-1 rounded-full">読込中...</div>
</header>
<div id="whiskyList" class="px-4 mt-6 space-y-3">
            ...
            onSnapshot(colRef, (snapshot) =&gt; {
                ...
                list.innerHTML = data.map(w =&gt; `
                    &lt;div class=&quot;bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex items-center justify-between&quot;&gt;
                        ...
                        &lt;div class=&quot;text-amber-800 font-bold&quot;&gt;${w.remaining || 100}%&lt;/div&gt;
                    &lt;/div&gt;
                `).join(&#39;&#39;) || &#39;&lt;div class=&quot;text-center py-20 text-slate-400&quot;&gt;ボトルがありません&lt;/div&gt;&#39;;
            });
        }
    });
